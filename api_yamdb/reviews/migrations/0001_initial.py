# Generated by Django 2.2.16 on 2022-06-22 07:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('moderator', 'moderator'), ('user', 'user')], default='user', help_text='Роль', max_length=15, verbose_name='Роль')),
                ('bio', models.TextField(blank=True, help_text='О себе', null=True, verbose_name='О себе')),
                ('email', models.EmailField(help_text='Адрес электронной почты', max_length=50, unique=True, verbose_name='Адрес электронной почты')),
